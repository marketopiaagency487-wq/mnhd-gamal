...
const PROJECTS = [
  {
    ...
    en: "Sarai",
    accent: "text-emerald",
    badge: "أكبر بحيرة قابلة للسباحة في مصر",
    badgeTone: "bg-emerald text-white",
    desc: "أضخم مشروعات مدينة مصر على مساحة 5.5 مليون متر مربع (نحو 1,300 فدان) على طريق السويس عند مدخل مدينة المستقبل وبجوار مدينتي. الميزة الأبرز هي البحيرة الصناعية الضخمة القابلة للسباحة — الأكبر من نوعها في مصر — مع تخصيص حوالي 18% فقط للمباني والباقي مساحات خضراء ومسطحات مائية.",
    facts: [
      ["5.5M م²", "المساحة الإجمالية"],
      ["18%", "فقط نسبة المباني"],
      ["70 ألف", "سعر المتر يبدأ من (جنيه)"],
    ...
    rows: [
      ...
      ["الموقع", "طريق السويس — بجوار مدينتي"],
    ],
    ideal:
      "مثالي لمن يبحث عن مساحات خضراء واسعة وحياة حول البحيرة، أو دخول باستثمار متوسط في منطقة سريعة النمو.",
  },
  {
    id: "tajcity",
  ...
  },
  {
    ...
    rows: [
      ["الفيلات", "تبدأ من حوالي 4,500,000 جنيه"],
      ["أنواع الوحدات", "شقق · دوبلكس · تاون هاوس · فيلات"],
...
const PLANS = [
  {
    ...
    title: "مقدم 5% وتقسيط 10 سنوات",
    rows: [
      ["مقدم الحجز", "يبدأ من 5%"],
      ["مدة التقسيط", "تصل إلى 10 سنوات"],
...
const AMENITIES = [
  ["بحيرة صناعية قابلة للسباحة", "الأكبر من نوعها في مصر داخل كمبوند سراي"],
...
const GALLERY: [string, string][] = [
  ["/images/gallery-1.webp", "بحيرة كمبوند سراي القاهرة الجديدة — مدينة مصر"],
  ["/images/gallery-2.webp", "وحدات كمبوند تاج سيتي القاهرة الجديدة على طريق السويس"],
  ["/images/gallery-3.webp", "كمبوند ذا باترفلاي مدينة المستقبل"],
  ["/images/gallery-4.webp", "المساحات الخضراء بكمبوندات مدينة مصر بالقاهرة الجديدة"],
  ["/images/gallery-5.webp", "المسطحات المائية داخل كمبوند سراي"],
  ["/images/gallery-6.webp", "الخدمات والمرافق بمشروعات مدينة مصر للإسكان والتعمير"],
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "يقع كمبوند سراي على طريق السويس عند مدخل مدينة المستقبل وبجوار مدينتي، ويمتد على مساحة 5.5 مليون متر مربع (نحو 1,300 فدان). ويضم أكبر بحيرة صناعية قابلة للسباحة في مصر، مع تخصيص حوالي 18% فقط من المساحة للمباني والباقي للمساحات الخضراء والمسطحات المائية.",
  },
  {
